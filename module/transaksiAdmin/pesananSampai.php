                ...
                <tbody>
                    ...
                    foreach($adminTransaksiSampai as $row): ?>
                        <tr>
                            ...
                            <td><?= $row["resi"]; ?></td>
                            <td>
                                <button type="button" class="btn btn-warning btn-sm btn-block" data-toggle="modal" data-target="#bukti_bayar_sampai<?= $f;?>">Lihat Bukti Bayar</button>
                            </td>
                            <!-- modal bukti bayar -->
                            <div class="modal fade" id="bukti_bayar_sampai<?= $f;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
